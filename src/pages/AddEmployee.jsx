...
export default function AddEmployee({ onCancel, onAdd }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-24 lg:pb-0 relative stagger">
      <style>{`
        .max-w-4xl { max-width: 100% !important; padding: 0 !important; }
        .bg-white.rounded-2xl { background: var(--surface) !important; border: 1px solid var(--line) !important; border-radius: var(--r) !important; box-shadow: var(--shadow-sm) !important; }
        .text-2xl.font-bold { font-family: var(--display) !important; font-size: 30px !important; font-weight: 700 !important; letter-spacing: -1px !important; color: var(--ink) !important; }
        .font-bold.text-slate-800.text-base { font-family: var(--display) !important; font-size: 18px !important; font-weight: 700 !important; letter-spacing: -0.4px !important; color: var(--ink) !important; border-bottom: 1px solid var(--line-2) !important; padding-bottom: 12px !important; margin-bottom: 18px !important; }
        .text-xs.font-extrabold.text-slate-500.uppercase { font-family: var(--display) !important; font-size: 14px !important; font-weight: 700 !important; text-transform: none !important; letter-spacing: 0 !important; color: var(--ink) !important; }
        
        /* Form fields */
        .space-y-1 { margin-bottom: 16px !important; }
        .space-y-1 > label { display: block !important; font-size: 12px !important; font-weight: 700 !important; margin-bottom: 7px !important; color: var(--ink-2) !important; text-transform: none !important; letter-spacing: normal !important; }
        .space-y-1 > input, .space-y-1 > select, .space-y-1 > div > input { width: 100% !important; padding: 12px 14px !important; border: 1px solid var(--line) !important; border-radius: 12px !important; background: var(--surface-2) !important; font-family: var(--sans) !important; font-size: 13px !important; color: var(--ink) !important; outline: none !important; transition: .15s !important; }
        .space-y-1 > input:focus, .space-y-1 > select:focus, .space-y-1 > div > input:focus { border-color: var(--brand) !important; background: var(--surface) !important; box-shadow: 0 0 0 3px var(--brand-soft) !important; }
        
        /* Buttons */
        .bg-emerald-600, .bg-primary { background: linear-gradient(120deg, var(--brand), var(--brand-2)) !important; color: #fff !important; box-shadow: 0 8px 18px rgba(189,121,66,.3) !important; border-radius: 13px !important; font-family: var(--sans) !important; font-weight: 700 !important; border: none !important; }
        .bg-emerald-600:hover, .bg-primary:hover { transform: translateY(-2px) !important; box-shadow: 0 12px 24px rgba(189,121,66,.38) !important; }
        .border-slate-200.hover\\:bg-slate-50 { background: var(--surface) !important; border: 1px solid var(--line) !important; color: var(--ink) !important; border-radius: 13px !important; font-family: var(--sans) !important; font-weight: 700 !important; padding: 12px 18px !important; }
        .border-slate-200.hover\\:bg-slate-50:hover { border-color: var(--brand-3) !important; transform: translateY(-1px) !important; }
        
        /* Comprehensive Color Overrides */
        .bg-slate-50 { background-color: var(--surface-2) !important; }
        .bg-slate-100, .bg-slate-200 { background-color: var(--surface-3) !important; }
        .border-slate-100, .border-slate-200, .border-slate-350 { border-color: var(--line) !important; }
        .text-slate-400, .text-slate-500, .text-slate-505, .text-slate-555 { color: var(--ink-3) !important; }
        .text-slate-600, .text-slate-650, .text-slate-655, .text-slate-700, .text-slate-750 { color: var(--ink-2) !important; }
        .text-slate-800, .text-slate-900 { color: var(--ink) !important; }
        
        .bg-emerald-500 { background: var(--sage) !important; color: white !important; }
        .text-emerald-500, .text-emerald-600 { color: var(--sage) !important; }
        .bg-emerald-50\\/10, .bg-emerald-50\\/20 { background-color: var(--sage-soft) !important; }
        .border-emerald-300 { border-color: var(--sage) !important; }
        
        .bg-rose-50\\/20, .bg-rose-50\\/30 { background-color: var(--coral-soft) !important; }
        .text-rose-500, .text-rose-600 { color: var(--coral) !important; }
        .border-rose-500, .border-rose-300 { border-color: var(--coral) !important; }
        
        .bg-primary\\.text-white { background: var(--brand) !important; color: white !important; box-shadow: var(--shadow-sm) !important; }
        .text-primary { color: var(--brand) !important; }
        .border-primary, .hover\\:border-primary\\/50:hover { border-color: var(--brand) !important; }
        .bg-primary\\/5 { background-color: var(--brand-soft) !important; }
        .ring-primary\\/20 { --tw-ring-color: var(--brand-soft) !important; box-shadow: 0 0 0 4px var(--brand-soft) !important; }
        
        /* Utility overrides */
        .text-\\[9px\\], .text-\\[10px\\], .text-\\[11px\\] { font-family: var(--sans) !important; }
      ...
      <div className="panel" style={{ padding: '24px', overflowX: 'auto', marginBottom: '24px' }}>
        <div className="flex items-center justify-between min-w-[650px] px-2" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', minWidth: '650px', padding: '0 8px' }}>
          {steps.map((step, idx) => {
            ...
            return (
              <React.Fragment key={step.number}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{
                    width: '32px', height: '32px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 'bold', transition: '0.2s',
                    backgroundColor: isCompleted ? 'var(--sage)' : isActive ? 'var(--brand)' : 'var(--surface-2)',
                    color: isCompleted ? '#fff' : isActive ? '#fff' : 'var(--ink-3)',
                    boxShadow: isActive ? '0 0 0 4px var(--brand-soft)' : 'none',
                    border: isCompleted || isActive ? 'none' : '1px solid var(--line)'
                  }}>
                    {isCompleted ? 'âœ“' : step.number}
                  </div>
                  <div style={{ textAlign: 'left' }}>
                    <span style={{ fontSize: '12px', display: 'block', fontWeight: 'bold', transition: '0.2s', color: isActive ? 'var(--brand)' : isCompleted ? 'var(--ink)' : 'var(--ink-3)' }}>
                      {step.label}
                    </span>
                    <span style={{ fontSize: '10px', color: 'var(--ink-3)', fontWeight: '500', display: 'block' }}>
                ...
                {/* Progress Bar Line */}
                {idx < steps.length - 1 && (
                  <div style={{ flex: 1, margin: '0 16px', height: '2px', position: 'relative' }}>
                    <div style={{ position: 'absolute', inset: 0, backgroundColor: 'var(--line)', borderRadius: '4px' }}></div>
                    <div style={{ position: 'absolute', inset: 0, backgroundColor: 'var(--brand)', borderRadius: '4px', transition: '0.3s', width: isCompleted ? '100%' : '0' }}></div>
                  </div>
                )}
              </React.Fragment>
            );
      ...
      <form onSubmit={handleSubmit} className="panel">
        ...
        <div className="p-6 sm:p-8 flex-1">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start border-b border-slate-100 pb-6">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <label className="av" style={{ width: '96px', height: '96px', borderRadius: '50%', overflow: 'hidden', border: '2px dashed var(--line)', backgroundColor: 'var(--surface-2)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: '0.2s', textAlign: 'center', flexShrink: 0 }}>
                      {formData.avatarUrl ? (
                        <img src={formData.avatarUrl} alt="Cropped preview" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                      ) : (
                        <>
                          <Camera size={24} style={{ color: 'var(--ink-3)', transition: '0.2s' }} />
                          <span style={{ fontSize: '10px', color: 'var(--ink-3)', fontWeight: 'bold', marginTop: '4px' }}>Upload</span>
                        </>
                      )}
                      <input 
                        type="file" 
                    ...
                    {formData.avatarUrl && (
                      <button 
                        ...
                        className="btn ghost"
                        style={{ padding: '8px 12px', fontSize: '11px', color: 'var(--coral)' }}
                      >
                        <Trash2 size={12} />
                        Remove
                      </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="field">
                  <label>National ID * (00000-0000000-0)</label>
                  <input 
                    type="text"
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="sec-head"><h3>Contact Details</h3></div>
              
              {/* Address Details */}
              <div className="space-y-4">
                <div className="sec-head"><h4>Address Details</h4></div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="sec-head"><h4>Emergency Contact Information</h4></div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="sec-head"><h3>Employment Details</h3></div>
              
              {/* Organizational Placement */}
              <div className="space-y-4">
                <div className="sec-head"><h4>Organizational Placement</h4></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="sec-head"><h4>Access & System Settings</h4></div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="sec-head"><h4>Contract & Location Parameters</h4></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {/* Probation End Date */}
                  <div className="field">
                    <label>Probation End Date (Optional) (dd - mm - yyyy)</label>
                    <input 
                      type="date"
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="sec-head"><h4>Time-Off Allocations</h4></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Annual Leave */}
                  <div className="field">
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div className="sec-head"><h3>Salary & Bank Details</h3></div>
              
              {/* Compensation & Allowances */}
              <div className="space-y-4">
                <div className="sec-head"><h4>Compensation & Allowances</h4></div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="sec-head"><h4>Disbursement Bank Details</h4></div>
          ...
          {currentStep === 5 && (
            <div className="space-y-6">
              <div>
                <div className="sec-head"><h3>Documents Onboarding</h3></div>
          ...
          {currentStep === 6 && (
            <div className="space-y-6">
              <div className="sec-head"><h3>Review & Confirm</h3></div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '12px' }}>
        ...
        <span style={{ fontWeight: '600', color: value ? 'var(--sage)' : 'var(--ink-3)' }}>
          {value ? 'âœ“ Attached' : 'Not attached'}
        </span>
      </div>
      ...
      <label 
        ...
        className="doc"
        style={{
          border: `2px dashed ${error ? 'var(--coral)' : isDragActive ? 'var(--brand)' : value ? 'var(--sage)' : 'var(--line)'}`,
          backgroundColor: error ? 'var(--coral-soft)' : isDragActive ? 'var(--brand-soft)' : value ? 'var(--sage-soft)' : 'var(--surface-2)',
          padding: '16px',
          display: 'flex',
      ...
      >
        <Upload style={{ marginBottom: '6px', color: error ? 'var(--coral)' : value ? 'var(--sage)' : 'var(--ink-3)' }} size={20} />
        <span style={{ fontSize: '11px', fontWeight: 'bold', color: 'var(--ink)', maxWidth: '200px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'block' }}>
          {value ? value : 'Choose file or drag here'}
        </span>
        <span style={{ fontSize: '9px', color: 'var(--ink-3)', marginTop: '2px', display: 'block' }}>
      ...
      {error && <p style={{ fontSize: '10px', fontWeight: 'bold', color: 'var(--coral)' }}>{error}</p>}
    </div>
  );
}
